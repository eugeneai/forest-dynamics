...
public class SimpleFDSimulationPresenter extends ApplicationFrame {
    ...
    public SimpleFDSimulationPresenter(String title) {
        super(title);
        ChartPanel chartPanel = (ChartPanel) simpleFDSimulationPanel();
     ...
     * @return A panel.
     */
    public static JPanel simpleFDSimulationPanel() {
    ...
    public static void main(String[] args) {
        ...
        SimpleFDSimulationPresenter demo = new SimpleFDSimulationPresenter(
